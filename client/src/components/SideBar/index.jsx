...
// useEffect(()=>console.log(selectedElement),[selectedElement])
  ...
  const getElementAtPosition = (x, y) => {
    return elements.find((element) => {
      if (element.type === "rect" || element.type === "circle" || element.type === "eclipse") {
        return (
          x >= element.offsetX &&
  ...
  const handleMouseDown = (e) => {
    ...
    if (tool === "select") {
      ...
      if (element) {
        ...
        setOffset({
          x: offsetX - element.offsetX,
          y: offsetY - element.offsetY,
        });
        return;
      }
    } else {
